...
class pathology{
	...
	function update_procedures($reg_id,$data)
	{
		// print_r($data);
		$con = new MySQLi(DBHOST,DBUSER,DBPASS,DBNAME);
		$query = "UPDATE lab_requests set status = 1,result = '$data->result' ,result_value = '$data->result_value', sample_used = '$data->sample_used' , sample_used_qty = '$data->sample_used_qty',min_value = '$data->min_value',max_value = '$data->max_value' , result_desc = '$data->result_desc' where reg_id = $reg_id and test_id = $data->test_id ";
		// print_r($query);
